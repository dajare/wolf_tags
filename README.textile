...
Wolf tags are very similar to XHTML or XML tags. With _WolfTags Plugin_ plugin enabled, you can use some standard WolfTags and even create more of your own.

_WolfTags Plugin_ will add the a similar functionality to Wolf CMS as that offered by "Radius tags":http://wiki.github.com/radiant/radiant/radius-tags in Radiant CMS (but with a preceding 'w:' instead of 'r:').
