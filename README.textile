...
**WOLF TAGS ARE NOT CURRENTLY USABLE : IN PROCESS OF PORTING**

h2. Brief

Wolf tags are very similar to HTML tags. With _WolfTags Plugin_ plugin enabled, you can use some standard Wolf tags and first of all easily create own Wolf tags.
...
The include line is required to assure that the class @WolfTags@ is defined before it is used to derive an other class from it.
...
Like HTML tags Wolf tags can have some content aswell. For example:
